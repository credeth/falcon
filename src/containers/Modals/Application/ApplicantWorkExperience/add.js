...
import { updateApplicantWorkExpRequest } from "../../../../redux/Applications/actions";
import { fetchApplicationByIdRequest } from "../../../../redux/Applications/actions";

interface Props extends FormComponentProps {
  closeModal: closeModal;
}

class AddApplicantWorkExpModal extends React.Component<Props> {
  state = {};
  componentWillReceiveProps = nextProps => {
    ...
    if (doneActions.UPDATE_APPLICANT_WORK_EXP_SUCCESS) {
      removeDoneActions(["UPDATE_APPLICANT_WORK_EXP_SUCCESS"]);
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchApplicationById: data => dispatch(fetchApplicationByIdRequest(data)),
  addWorkExp: data => dispatch(updateApplicantWorkExpRequest(data))
});
